...
public class frmMainMenu extends javax.swing.JFrame {
    ...
    private void btnExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExitActionPerformed
        int a = JOptionPane.showConfirmDialog(null, "Do you want to exit the application","Select",JOptionPane.YES_NO_OPTION); //yes or no option
        if(a == 0){
    ...
    private void btnSignOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignOutActionPerformed
        int a = JOptionPane.showConfirmDialog(null, "Do you want to sign out","Sign Out",JOptionPane.YES_NO_OPTION); //yes or no option
        if(a == 0){
            dispose();
            new frmLogin().setVisible(true); //goes back to the log in page
        }
