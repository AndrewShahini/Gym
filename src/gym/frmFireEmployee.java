...
public class frmFireEmployee extends javax.swing.JFrame {
    ...
    private void btnFireEmpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFireEmpActionPerformed
        int selectedIndex = listOfEmployee.getSelectedIndex(); //selected with the mouse
        if (selectedIndex != -1) {
            String selectedEmployee = listOfEmployee.getSelectedValue();
        for (int i = 0; i < employees.size(); i++) { //loops through the ArrayList till it finds the member to delete
        ...
        Employee.saveEmployeeList("employees.ser"); //saves it
